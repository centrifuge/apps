import { NotificationMessage } from '@centrifuge/gateway-lib/src/centrifuge-node-client'
import { DocumentStatus } from '@centrifuge/gateway-lib/src/models/document'
