...
describe('ContactsController', () => {
  ...
  const contactToCreate = new Contact('sarah', '0xc128924276e4e539111ca11b590b9447b26a8057')
  ...
  describe('create', () => {
    it('should return the created contact', async () => {
      ...
      const result = await contactsController.create({ user: { _id: ownerId } }, contactToCreate)
  ...
  describe('update', function() {
    it('should call the database service', async function() {
      ...
      await contactsController.updateById({ id: updateContactObject._id }, updateContactObject, {
        user: { _id: ownerId },
      })
