...
describe('SchemasController', () => {
  ...
  beforeEach(async () => {
    ...
    schemaToCreate = new Schema(schemaData.name, schemaData.attributes, schemaData.registries, schemaData.collaborators)
  ...
  describe('create', () => {
    it('should return the created schema', async () => {
      const schemasController = schemaModule.get<SchemasController>(SchemasController)
