...
describe('OrganizationController', () => {
  ...
  const organizationToCreate = new Organization('SomeOrganisation', '0xc128924276e4e539111ca11b590b9447b26a8055')
  ...
  beforeEach(async () => {
    ...
    databaseSpies.spyInsert = jest.spyOn(databaseService.organizations, 'insert')
    databaseSpies.spyUpdate = jest.spyOn(databaseService.organizations, 'update')
    databaseSpies.spyGetCursor = jest.spyOn(databaseService.organizations, 'getCursor')
  })

  describe('create', () => {
    it('should return the created organization', async () => {
      const organizationsController = organizationsModule.get<OrganizationsController>(OrganizationsController)
  ...
  describe('update', () => {
    it('should call the database service', async () => {
      ...
      await organizationsController.updateById({ id: updateOrganizationObject._id }, updateOrganizationObject, {})
