...
export const withApplicationContext = (
  ...
  return <AuthContext.Provider value={{ user, setUser, token, setToken }}>{Component}</AuthContext.Provider>
}
...
export const withAllProvidersAndContexts = (
  ...
  return withAxis(withApplicationContext(withNotificationContext(Component), user, setUser, token, setToken))
}
