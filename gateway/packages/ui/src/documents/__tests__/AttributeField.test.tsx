...
describe('AttributeField', () => {
  it('Should render a DECIMAL ', () => {
    ...
    const component = mount(withAllProvidersAndContexts(<AttributeField attr={attr} />))
    ...
    const disabled = mount(withAllProvidersAndContexts(<AttributeField attr={attr} isViewMode={true} />))
