...
describe('Funding Agreements', () => {
      ...
      funding_agreement: [
        {
          agreement_id: {
            type: 'bytes',
            value:
              '0x9278be3cacb26915a61a8a2f4fb4d2aa92c062f4c8b596ef7794d0da879b0f7b',
            key:
              '0x9ed63b1df0c1b6dc14b777a767ccb0562b7a0adf6f51bf0d90476f6833005f9a',
          },
          amount: {
        ...
        },
        {
          agreement_id: {
            ...
            value:
              '0x9278be3cacb26915a61a8a2f4fb4d2aa92c062f4c8b596ef7794d0da879b0f7b',
            key:
              '0x9ed63b1df0c1b6dc14b777a767ccb0562b7a0adf6f51bf0d93476f6833005f9a',
          },
          amount: {
            type: 'decimal',
            value: '998.06',
  ...
  it('Should render a Datatable with 2 funding Agreemtns and no request funding action', () => {
    ...
    const mappedToSortable = document.attributes.funding_agreement.map(
      (fundingAgreement: any) => {
        return {
          ...
          nft_address: fundingAgreement.nft_address
            ? fundingAgreement.nft_address.value
            : '',
    ...
    expect(
      component
        .find(Button)
        .findWhere(node => node.key() === 'create-funding-agreement').length,
    ).toEqual(0);
  });
  ...
  it('Should request a funding agreement successfully ', async () => {
    ...
    const fundingAction = component
      .find(Button)
      .findWhere(node => node.key() === 'create-funding-agreement');
    fundingAction.simulate('click');
    const fundingForm = component.find(FundingAgreementForm);
    await fundingForm.prop('onSubmit')({ data: 'data' });
  ...
  it('Should fail to request  a funding agreement', async () => {
    ...
    expect(onAsyncError).toHaveBeenCalledWith(
      error,
      'Failed to create funding agreement',
    );
  });
  ...
  it('Should not sign an agreement', async () => {
    ...
    expect(onAsyncError).toHaveBeenCalledWith(
      error,
      'Failed to sign funding agreement',
    );
  });
