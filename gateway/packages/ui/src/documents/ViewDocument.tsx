import { Contact, extendContactsWithUsers } from '@centrifuge/gateway-lib/src/models/contact'
import { Document, documentIsEditable } from '@centrifuge/gateway-lib/src/models/document'
