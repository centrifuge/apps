...
describe('Custom Attributes', () => {
  const attr = {
    ...
    'funding_agreement[0].signatures': {
      key: '0x3793e4c50c779a5d95ad944bf2f5ef503c25c3bfd7c2dded7bc8d26cf07c0a89',
      type: 'integer',
      value: '0',
    },
    ...
    transfer_details: {
      key: '0x4969ecc111902be33769deebd71d64a93871fee676949c0cdb3f90c2a5b43e0c',
      type: 'integer',
      value: '1',
    },
    'transfer_details[0].amount': {
      key: '0xdb1f17cfb5a17637ddd98b5f48a2af4ff752957129feb6c1c20aefb78798f0db',
      type: 'decimal',
      value: '200',
    },
    'transfer_details[0].currency': {
      key: '0x5dbdb4d9c58897b25fefa1215bfad9689ea163039c4bd950c572963770efc789',
      type: 'string',
      value: 'DAI',
    },
    'transfer_details[0].recipient_id': {
      key: '0x426b3c423311b87d506c90aedff0327b5d36934e4faa06c218de69f33e188561',
      type: 'bytes',
      value: '0x5f2bbfcf948a0083bbe77c0ad97a64142d6b1d48',
    },
    'transfer_details[0].sender_id': {
      key: '0x3b9ba4dc1805b6f980c2e872f07fa487a984128498cbf6137ecd88a9339ce800',
      type: 'bytes',
      value: '0x7c907d059737c821067a5e0beba19ee9242a45cb',
    },
    'transfer_details[0].settlement_date': {
      key: '0x7d2a30dfbca405146154ae79bfcdea62a3dcab0c86a4447db102cb28b44050fd',
      type: 'timestamp',
    ...
    'transfer_details[1].amount': {
      key: '0xb3c93fa717b4867f1c370297d4acdbf1902c1fbb45c375e2a83f9f3cace8e713',
      type: 'decimal',
      value: '20',
    },
    'transfer_details[1].currency': {
      key: '0x16da078bac66391c946c0c47d25fdce98ddc1b6499d871c046250523be045412',
      type: 'string',
      value: 'DAI',
    },
    'transfer_details[1].recipient_id': {
      key: '0x2c9394d69d95fb7ee5c841fc82b6a24be1e60c737ad6f7bc78fb87a24021b466',
      type: 'bytes',
      value: '0x5f2bbfcf948a0083bbe77c0ad97a64142d6b1d48',
    },
    'transfer_details[1].sender_id': {
      key: '0x22a7ac89649611373406b04deeff8d9fc79b2d1102eab685cb50001630134f6d',
      type: 'bytes',
      value: '0x7c907d059737c821067a5e0beba19ee9242a45cb',
    },
    'transfer_details[1].settlement_date': {
      key: '0x7d0974f40d5acd341c45cf3a07c4bb0a1cf77e19bd7314e2f72c0d35acc77cfb',
      type: 'timestamp',
