...
import { IssuerPoolCreateAssetTemplatePage } from './Configuration/CreateAssetTemplate'
import { IssuerPoolViewAssetTemplatePage } from './Configuration/ViewAssetTemplate'
...
export const IssuerPoolPage: React.FC = () => {
  ...
  return (
    <Switch>
      <Route path={`${path}/configuration/view-asset-template/:sid`} component={IssuerPoolViewAssetTemplatePage} />
      <Route path={`${path}/configuration/create-asset-template`} component={IssuerPoolCreateAssetTemplatePage} />
