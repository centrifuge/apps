...
let ContactsController = class ContactsController {
    ...
    updateById(params, updateContactObject, request) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.databaseService.contacts.update({ _id: params.id, ownerId: request.user._id }, Object.assign(Object.assign({}, updateContactObject), { ownerId: request.user._id }));
        });
    }
};
__decorate([
