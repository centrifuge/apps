...
var Tinlake = /** @class */ (function () {
    function Tinlake(provider, _a) {
        ...
        this.adminAdmit = function (registry, nft, principal, usr) {
            return _this.contracts.admit.admit(registry, nft, principal, usr, _this.ethConfig).then(function (txHash) {
                console.log("[Admit.admit] txHash: " + txHash);
                return waitAndReturnEvents(_this.eth, txHash, _this.contracts["nft"].abi);
            });
        };
        this.adminAppraise = function (loanID, appraisal) {
            return _this.contracts.appraiser.file(loanID, appraisal, _this.ethConfig).then(function (txHash) {
        ...
        this.repay = function (loan, wad, usrT, usr) {
            return _this.contracts.reception.repay(loan, wad, usrT, usr, _this.ethConfig).then(function (txHash) {
        ...
        this.eth = new Eth(this.provider, ethOptions);
        this.contracts = {
