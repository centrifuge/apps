...
export declare const TinlakeWithActions: {
    new (...args: any[]): {
        ...
        proxyIssue: (proxyAddress: string, nftRegistryAddress: string, tokenId: string) => Promise<import("./Tinlake").PendingTransaction>;
        proxyTransferIssue: (proxyAddress: string, nftRegistryAddress: string, tokenId: string) => Promise<import("./Tinlake").PendingTransaction>;
        proxyLockBorrowWithdraw: (proxyAddress: string, loanId: string, amount: string, usr: string) => Promise<import("./Tinlake").PendingTransaction>;
        proxyRepayUnlockClose: (proxyAddress: string, tokenId: string, loanId: string, registry: string) => Promise<import("./Tinlake").PendingTransaction>;
        provider: any;
    ...
    new (...args: any[]): {
        ...
        setMinimumJuniorRatio: (ratio: string) => Promise<import("./Tinlake").PendingTransaction>;
        approveAllowanceJunior: (user: string, maxCurrency: string, maxToken: string) => Promise<import("./Tinlake").PendingTransaction>;
        approveAllowanceSenior: (user: string, maxCurrency: string, maxToken: string) => Promise<import("./Tinlake").PendingTransaction>;
        provider: any;
        eth: import("./services/ethereum").ethI;
        ethOptions: any;
        ethConfig: import("./Tinlake").EthConfig;
    ...
    new (...args: any[]): {
        supplySenior: (currencyAmount: string) => Promise<import("./Tinlake").PendingTransaction>;
        redeemSenior: (tokenAmount: string) => Promise<import("./Tinlake").PendingTransaction>;
        getSeniorTokenAllowance: (owner: string) => Promise<import("bn.js")>;
        approveSeniorToken: (tokenAmount: string) => Promise<import("./Tinlake").PendingTransaction>;
        supplyJunior: (currencyAmount: string) => Promise<import("./Tinlake").PendingTransaction>;
        redeemJunior: (tokenAmount: string) => Promise<import("./Tinlake").PendingTransaction>;
        getJuniorTokenAllowance: (owner: string) => Promise<import("bn.js")>;
        approveJuniorToken: (tokenAmount: string) => Promise<import("./Tinlake").PendingTransaction>;
    ...
    new (...args: any[]): {
        ...
        getOwnerOfCollateral: (nftRegistryAddress: string, tokenId: string) => Promise<import("bn.js")>;
    ...
    new (...args: any[]): {
        ...
        approveCurrency: (usr: string, currencyAmount: string) => Promise<import("./Tinlake").PendingTransaction>;
        approveSeniorForCurrency: (currencyAmount: string) => Promise<import("./Tinlake").PendingTransaction | undefined>;
        approveJuniorForCurrency: (currencyAmount: string) => Promise<import("./Tinlake").PendingTransaction | undefined>;
        provider: any;
        eth: import("./services/ethereum").ethI;
        ethOptions: any;
        ethConfig: import("./Tinlake").EthConfig;
    ...
    new (...args: any[]): {
        ...
        approveNFT: (nftAddress: string, tokenId: string, to: string) => Promise<import("./Tinlake").PendingTransaction>;
        setNFTApprovalForAll: (nftAddress: string, to: string, approved: boolean) => Promise<import("./Tinlake").PendingTransaction>;
        ...
        getNFTOwner: (nftAddresss: string, tokenId: string) => Promise<import("bn.js")>;
