                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell style={{ textAlign: 'end' }}>
                        <LoadingValue done={ totalFinanced !== undefined}>{addThousandsSeparators(toPrecision(baseToDisplay(totalFinanced || '0', 18), 0))} DAI</LoadingValue>
                      </TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell scope="row">Total Financings</TableCell>
                      <TableCell style={{ textAlign: 'end' }}>
                        <LoadingValue done={totalFinancings !== undefined}>
                          {totalFinancings}
                        </LoadingValue>
                      </TableCell>
                    </TableRow>
