    ...
    return <Box>
      ...
      >
        ...
        <Paragraph margin={{ top: 'medium', bottom: 'medium' }}>
          To invest in this pool please provide your information to go through KYC. Submit your information below to start the KYC and onboarding process. The Issuer will shortly reach out to you.
        </Paragraph>
        ...
        <Box direction="row" gap={'medium'}>
          <Box basis={'1/2'}>
            ...
            <FormField label="Type of Investor">
              <Select placeholder="Select investor type" options={['Individual', 'Representing a legal entity']} onChange={() => {}} />
            </FormField>
          </Box>
          <Box basis={'1/2'}>
            ...
            <FormField label="Estimated Size of Investment, USD">
              <Select placeholder="Select investor type" options={['<25,000 USD', '25,000-50,000 USD', '>50,000 USD']} onChange={() => {}} />
            </FormField>
          </Box>
        </Box>
