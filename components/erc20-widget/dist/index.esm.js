...
var colorStyle = function colorStyle(name, value, theme, required) {
  return css(["", ":", ";"], name, normalizeColor(value, theme));
};
...
var Close = function Close(props) {
  return React.createElement(StyledIcon, _extends$2({
    viewBox: "0 0 24 24",
    a11yTitle: "Close"
...
var base$1 = generate(baseSpacing, scale);
var borderWidth = 1;
var fwRegular = 400;
var fwMedium = 500;
var fwDemibold = 600;
...
var textSizes = _objectSpread({}, textSpecs, {
  extend: function extend(props) {
    return css(["", ";", ""], props.textAlign && props.textAlign === "justify" && css(["text-align:justify;"]), props.hyphens && css(["hyphens:", ";"], props.hyphens === true ? "auto" : "unset"));
  }
});
/*
  THEME BOI
...
var axisThemeConfig = deepMerge(base$1, {
  global: {
  ...
  icon: {
    extend: css(["fill:", ";stroke:", ";"], black, black)
  },
  heading: {
    weight: fwDemibold,
    responsiveBreakpoint: null,
    extend: function extend(props) {
      return css(["font-family:", ";"], ffStack);
    }
  },
  paragraph: textSizes,
  text: textSizes,
  anchor: {
    ...
    hover: {
      extend: css(["color:", ";"], brandColor)
    },
    extend: css(["&:active{opacity:0.9;}"])
  },
  box: {
    extend: function extend(props) {
      return css(["", ""], props.responsiveChildren && css(["> *{flex:1;}"]));
    }
  },
  button: {
    padding: {
    ...
    extend: function extend(props) {
      return css(["font-weight:", ";font-family:", ";text-align:center;font-size:16px;line-height:24px;", " ", " ", " ", ""], fwMedium, ffStack, !props.disabled && css(["&:hover{box-shadow:none;border-color:", ";", "}&:active{opacity:0.9;}"], brandColor, !props.primary && css(["color:", ";"], brandColor) || css(["background-color:", ";"], brandColor)), !props.textAlign ? css(["text-align:center;"]) : css(["text-align:", ";"], props.textAlign), props.underline && css(["text-decoration:underline;"]), props.white && css(["&:hover{background-color:", ";border-color:", ";}"], white, white));
    }
  },
  calendar: {
  ...
  textInput: {
    extend: function extend(props) {
      return css(["", ""], props.newsletter && css(["font-weight:", ";font-family:", ";color:", ";border:none;border-bottom:", "px solid ", ";border-radius:0;padding-bottom:calc(11px - 1px);"], fwMedium, ffStack, black, borderWidth, props.newsletter && props.dark ? black : white));
    }
  },
  formField: {
    label: {
    ...
    margin: 0,
    extend: css(["label{line-height:1;}input{padding:16px 0 15px 0;line-height:1;}button{box-shadow:none;}"])
  },
  table: {
    /* NOTE:
     *
  ...
  tabs: {
    gap: "none",
    header: {
      extend: css(["justify-content:flex-start;"])
    },
    panel: {
      extend: css([""])
    },
...
var GlobalsStyles = createGlobalStyle(_templateObject(), AvenirNextLTW01, AvenirNextLTW01_500, AvenirNextLTW01_600, fwDemibold, ffStack);
...
var AxisTheme = function AxisTheme(_ref) {
  ...
  }, rest), React.createElement(GlobalsStyles, null), React.createElement(ThemeContext.Consumer, null, function (theme) {
...
var Erc20Widget = function Erc20Widget(_ref2) {
  ...
  var _useState5 = useState(search ? undefined : tokens[0]),
      _useState6 = _slicedToArray(_useState5, 2),
      selectedToken = _useState6[0],
      setToken = _useState6[1];

  var _useState7 = useState(tokens),
  ...
  var renderAddress = function renderAddress() {
    return /*#__PURE__*/React.createElement(Box, {
      ...
      style: overflowStyle
    }, "Account: ", account), /*#__PURE__*/React.createElement(Box, {
      onClick: function onClick() {
  ...
  return /*#__PURE__*/React.createElement(AxisTheme, {
    theme: specialTheme
  }, /*#__PURE__*/React.createElement(Box, {
    direction: "column",
    align: "start",
  ...
  }, renderToken(selectedToken)), tokens.length > 1 && /*#__PURE__*/React.createElement(Box, {
    direction: "row",
    gap: "small",
    align: "end",
    fill: "horizontal",
...
export { Erc20Widget$1 as Erc20Widget };
