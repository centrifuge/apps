...
const LoanData: React.FC<Props> = (props: Props) => {
  ...
  const { data: loanData } = useLoan(props.poolConfig.addresses.ROOT_CONTRACT, props.loan?.loanId as string)
            ...
            <Table>
              <TableBody>
                <TableRow>
                  ...
                  <TableCell style={{ textAlign: 'end' }}>
                    <LoadingValue done={props.loan?.riskGroup !== undefined && riskGroup?.recoveryRatePD !== undefined}>
