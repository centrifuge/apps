import { Box, IconPieChart, IconUser, Stack } from '@centrifuge/fabric'
  ...
  return (
    <Box>
      ...
      <Stack gap={1} marginLeft={1} marginRight={1}>
        <NavigationItem label="Pools" href="/pools" icon={<IconUser size="16px" />} />
        <NavigationItem label="NFTs" href="/nfts" icon={<IconUser size="16px" />} />
        ...
        <NavigationItem label="Issuers" icon={<IconPieChart size="16px" />}>
